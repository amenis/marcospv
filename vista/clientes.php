...
<head>
    ...
    <link rel="stylesheet" href="<?php echo urlsite;?>vista/css/clientes.css">
</head>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="row2">
            <button class="btn btn-primary" data-toggle="modal" data-target="#new_client"><i class="fa fa-plus mr-3"></i>Agregar</button>
        </div>
        <div class="row3">
            <table class="table table-striped" style="margin-top:80px;" id="tbl-clients">
                <thead>
                    <tr>
                        <th>Nombre</th>
                        <th>Apellidos</th>
                            ...
                            <td>
                                <div class="dropdown dropdown-action" style="display:'.$display.'" >
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(68px, 27px, 0px);">
                                        <a class="dropdown-item" href="#" onclick="getClient(' . $c['id_cliente'] . ')" ><i class="fa fa-pencil-alt m-r-5"></i> Editar</a>
                        ';
                        if($_SESSION['permition'] === 'Administrador'){
                                    echo'<a class="dropdown-item" href="#" onclick="baja(' . $c['id_cliente'] . ')"><i class="fa fa-trash m-r-5"></i> Eliminar</a>
                                    </div>
                                </div>
                            </td>
                        </tr>               
    ...
    <div class="modal fade bs-example-modal-lg-udp" tabindex="-1" id="update_client" role="dialog" aria-labelledby="search" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form id="form_mod_client">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="mod_apellidos" name="apellidos" placeholder="Ingresa apellidos del cliente"  >
                        </div>
                        <div class="form-group">
                    ...
                    <div class="text-right m-t-20">
                        ...
                        <button type="button" class="btn btn-primary" onclick="editClient()">Guardar</button>                       
                        <?php endif;?>
    ...
    <div class="modal fade bs-example-modal-lg-udp" tabindex="-1" id="new_client" role="dialog" aria-labelledby="search" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="newClient">
                        ...
                        <div class="form-group">
                            <label for="">Apellidos</label>
                            <input type="apellidos" class="form-control" id="apellidos" name="apellidos" placeholder="Ingresa apellidos del cliente"  >
                        </div>
                        <div class="form-group">
                            <label for="">domicilio</label>
                    ...
                    <div class="text-right m-t-20">
                        <button type="button" class="btn btn-primary" onclick="newClient()">Guardar</button>
    ...
    <script src="<?php echo urlsite;?>vista/js/clientes.js"></script>
